...
import code2t.com.dvp.anno.Internal;

import java.util.Collection;
import java.util.Map;
import java.util.Objects;

import static code2t.com.dvp.exception.Exceptions.illegalArgument;

/**
 * Utility class for validating method arguments.
 */
@Internal
public class ValidationToolkits {

    private ValidationToolkits() {
    }
